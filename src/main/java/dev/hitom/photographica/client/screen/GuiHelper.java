...
class GuiHelper {
    ...
    // ── Convenience fill ────────────────────────────────────────────────────────
    static void fill(DrawContext ctx, int x1, int y1, int x2, int y2, int color) {
    ...
    static void drawSlot(DrawContext ctx, int ix, int iy) {
    ...
    static void drawSlotHot(DrawContext ctx, int ix, int iy) {
    ...
    static void drawSlotEmber(DrawContext ctx, int ix, int iy) {
        ctx.fill(ix - 2, iy - 2, ix + 18, iy + 18, PANEL_SHADOW);
    ...
    static void drawRule(DrawContext ctx, int x, int y, int w) {
        ctx.fill(x, y,     x + w, y + 1, PANEL_SHADOW);
        ctx.fill(x, y + 1, x + w, y + 2, PANEL_LIGHT);
    }

    // ── Nameplate (9px brass strip + 1px shadow) ─────────────────────────────────
    static void drawNameplate(DrawContext ctx, int x, int y, int w) {
    ...
    static void drawLcd(DrawContext ctx, int x, int y, int w, int h) {
    ...
    static void drawWell(DrawContext ctx, int x, int y, int w, int h) {
    ...
    static void drawPip(DrawContext ctx, int x, int y, int color) {
