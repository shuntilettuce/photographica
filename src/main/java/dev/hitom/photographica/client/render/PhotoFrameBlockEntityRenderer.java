 ...
 *   - Model occupies [1,1,0]→[15,15,2] in block units.
 *   - Photo quad drawn at z = 2/16 + ε, covering x ∈ [2,14], y ∈ [4,12]
 *     which preserves the 3:2 aspect ratio of captured photos (12 × 8 pixels).
...
public class PhotoFrameBlockEntityRenderer implements BlockEntityRenderer<PhotoFrameBlockEntity> {
    ...
    private static final float Y0 = 4f / 16f;   // bottom of photo (3:2 centered in 14px frame)
    private static final float Y1 = 12f / 16f;  // top of photo
