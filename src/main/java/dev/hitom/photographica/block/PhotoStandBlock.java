...
public class PhotoStandBlock extends BlockWithEntity {
    ...
    // Bounding box: 14px wide, ~7px tall, nearly full depth.
    // SOUTH/NORTH: stand extends along z. EAST/WEST: stand extends along x.
    private static final VoxelShape SHAPE_NS = VoxelShapes.cuboid(1.0/16, 0, 2.0/16, 15.0/16, 7.0/16, 14.0/16);
    private static final VoxelShape SHAPE_EW = VoxelShapes.cuboid(2.0/16, 0, 1.0/16, 14.0/16, 7.0/16, 15.0/16);
