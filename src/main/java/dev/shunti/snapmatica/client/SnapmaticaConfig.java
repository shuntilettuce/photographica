...
/**
 * Persists minecraft-side camera settings that should survive leaving a world / restarting
...
public final class SnapmaticaConfig {
    ...
    private static final Path FILE =
            net.minecraftforge.fml.loading.FMLPaths.CONFIGDIR.get().resolve("snapmatica.properties");

    /** Load saved settings into {@link SnapmaticaClient}. Called once at minecraft init. */
    public static void load() {
        ...
        SnapmaticaClient.showCameraPath         = getBool(p, "showCameraPath",        SnapmaticaClient.showCameraPath);
    ...
    public static void save() {
        ...
        p.setProperty("showCameraPath",         Boolean.toString(SnapmaticaClient.showCameraPath));
        ...
        try {
            ...
            try (OutputStream out = Files.newOutputStream(FILE)) {
                p.store(out, "Snapmatica minecraft settings");
            }
        } catch (IOException e) {
