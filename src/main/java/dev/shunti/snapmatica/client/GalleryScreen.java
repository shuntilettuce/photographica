...
public class GalleryScreen extends Screen {
    ...
    private void drawCell(GuiGraphics ctx, MediaLibrary.Entry e, int x, int y, int w, int h, boolean hover) {
        ...
        ResourceLocation tex = MediaLibrary.thumbnail(e);
        if (tex != null) {
    ...
    private void renderViewer(GuiGraphics ctx) {
        MediaLibrary.Entry e = entries.get(viewing);
        ResourceLocation tex = MediaLibrary.texture(e);
    ...
    private void drawFitted(GuiGraphics ctx, ResourceLocation tex, int bx, int by, int bw, int bh, float ar) {
        ...
        ctx.blit(net.minecraft.client.renderer.RenderType::guiTextured,
