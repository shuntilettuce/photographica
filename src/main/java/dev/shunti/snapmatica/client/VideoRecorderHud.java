...
public final class VideoRecorderHud {
    ...
    // See ViewfinderOverlay.render for why this splits at 1.21 (Timer vs float).
    ...
    private static void renderRecording(GuiGraphics ctx, Minecraft mc) {
        ...
        int w1 = tr.width(recLabel);
        int w2 = tr.width(timeLabel);
    ...
    private static void renderPostProcessing(GuiGraphics ctx, Minecraft mc) {
        ...
        Component msg   = VideoRecorder.getPpMessage();
        ...
        ctx.drawCenteredString(tr, Component.literal("⚙ ").append(msg), sw / 2, panelY + 4, CREAM);
