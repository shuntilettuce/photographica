...
public final class PhotoCapture {
    ...
    public static void take() {
        ...
        // HumanoidArm the long exposure for slow shutters. capturePending stays false in that case:
    ...
    public static void onBeforeTranslucent() {
        ...
        EvfBlurRenderer.updateDepthFar(worldProjection(mc),
                mc.gameRenderer.getDepthFar(), Math.max(rd * 64f, 256f));
    ...
    public static void onWorldRenderEnd() {
        ...
        if (nowMs - lastAfQueryMs >= AF_QUERY_INTERVAL_MS) {
            ...
            float[] af = afPointDirection(mc, camera.getYRot(), camera.getXRot());
