...
public final class AutoFocus {
    ...
    // Manual-focus rack, in dioptres per minecraft tick (20 Hz). RATE is the fraction of the
    ...
    private static boolean isSeeThrough(net.minecraft.world.level.block.state.BlockState st) {
        ...
        return b instanceof net.minecraft.world.level.block.HalfTransparentBlock   // glass, stained, tinted
