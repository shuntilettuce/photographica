...
public class FilmStripScreen extends Screen {
    ...
    public void render(DrawContext ctx, int mouseX, int mouseY, float delta) {
        ...
        ctx.drawCenteredTextWithShadow(textRenderer, Text.literal("NEGATIVE"), cx, py + 6, GuiHelper.BRASS_BRIGHT);

        if (exposures.isEmpty()) {
            ctx.drawCenteredTextWithShadow(textRenderer,
                    Text.literal("NO EXPOSURES"), cx, py + PANEL_H / 2 - 5, GuiHelper.CREAM_FAINT);
