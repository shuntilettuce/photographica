...
public final class PhotoCapture {
     ...
     */
    private static org.joml.Matrix4f worldProjection(Minecraft mc) {
    ...
    public static void onWorldRenderEnd() {
        ...
        if (nowMs - lastAfQueryMs >= AF_QUERY_INTERVAL_MS) {
            ...
            // No Distant Horizons fallback here: DH has no 26 build, so a raycast miss
            // simply leaves the focus at infinity, which reads distant terrain as sharp.
            // Correct anyway — see the 1.21.x tree for the LOD path.
        }
