...
public final class Freecam {
    ...
    public static void addPathKeyframe(Minecraft client) {
        ...
        if (client.player == null) return;
        if (dist < 0) {
            client.gui.setOverlayMessage(Component.translatable("snapmatica.path.keyframe_first", path.size()), true);
        } else {
            client.gui.setOverlayMessage(Component.translatable("snapmatica.path.keyframe_added",
    ...
    public static void deleteTargetedKeyframe(Minecraft client) {
        ...
        if (client.player != null) {
            client.gui.setOverlayMessage(Component.translatable("snapmatica.path.keyframe_removed", path.size()), true);
        }
    }
    ...
    public static void clearPath(Minecraft client) {
        ...
        stopPathPlayback();
        if (client.player != null) {
            client.gui.setOverlayMessage(Component.translatable("snapmatica.path.cleared"), true);
        }
    }
    ...
    public static void togglePathPlayback(Minecraft client) {
        ...
        if (path.size() < 2) {
            if (client.player != null) {
                client.gui.setOverlayMessage(Component.translatable("snapmatica.path.too_short"), true);
            }
            return;
        }
        pinActive = false;
    ...
    public static void insertKeyframeOnCurve(Minecraft client) {
        ...
        if (client.player != null) {
            client.gui.setOverlayMessage(Component.translatable("snapmatica.path.keyframe_inserted", path.size()), true);
        }
    }
