 ...
 *
 * <p>Photos used to be saved as PNG with no metadata at all, so a photo said nothing
 * about the aperture, shutter speed, ISO, lens or time it was taken with. Writing Exif
 * means an ordinary photo viewer shows the same numbers the viewfinder did, and sorts
 * the photos by when they were actually taken.
 *
...
public final class PhotoWriter {
	...
	private static final String MAKE = "Snapmatica";
