...
public final class EvfBlurRenderer {
    ...
    private static void updateCameraMotion(MinecraftClient mc, int fbW, int fbH,
        ...
        double yaw = camera.getYaw(), pitch = camera.getPitch();
        net.minecraft.util.math.Vec3d camPos = SnapmaticaClient.cameraPos(mc);
    ...
    public static void markMotionSampled() {
        ...
        if (mc.player == null) { haveMotionRef = false; return; }
        net.minecraft.client.render.Camera camera = mc.gameRenderer.getCamera();
        prevYaw = camera.getYaw();   prevPitch = camera.getPitch();
        net.minecraft.util.math.Vec3d camPos = SnapmaticaClient.cameraPos(mc);
    ...
    public static void renderBlur(int fx, int fy, int fx2, int fy2,
        ...
        *///?}
        ...
        //? if >=1.21.10 {
        int liveDepthTex = (mainFb.getDepthAttachment()
                instanceof net.minecraft.client.texture.GlTexture glDepthLive)
                ? glDepthLive.getGlId() : 0;
        //?} else {
        /*int liveDepthTex = mainFb.getDepthAttachment();
        *///?}
    ...
    public static void applyBlur(boolean forCapture, boolean captureHQ) {
        ...
        boolean viewfinderUp = SnapmaticaClient.viewfinderActive(mc) && mc.currentScreen == null;
     ...
     */
    private static void applyAmbientBlur(MinecraftClient mc) {
