...
public final class CameraScrollHandler {
	...
	public static boolean onScroll(double delta) {
		...
		if (alt) {
			ItemStack vstack = mc.player.getMainHandItem();
			if (!(vstack.getItem() instanceof VideoCameraItem))
				vstack = mc.player.getOffhandItem();
			if (vstack.getItem() instanceof VideoCameraItem) {
		...
		boolean ctrl = InputConstants.isKeyDown(mc.getWindow().getWindow(), GLFW.GLFW_KEY_LEFT_CONTROL)
