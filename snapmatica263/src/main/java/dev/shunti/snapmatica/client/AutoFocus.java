...
public final class AutoFocus {
    ...
    private static void tickAfPoint(Minecraft mc) {
        ...
        float dx = 0f, dy = 0f;
        if (CameraScrollHandler.keyDown(com.mojang.blaze3d.platform.InputConstants.KEY_LEFT))  dx -= AF_POINT_STEP;
        if (CameraScrollHandler.keyDown(com.mojang.blaze3d.platform.InputConstants.KEY_RIGHT)) dx += AF_POINT_STEP;
        if (CameraScrollHandler.keyDown(com.mojang.blaze3d.platform.InputConstants.KEY_UP))    dy -= AF_POINT_STEP;
        if (CameraScrollHandler.keyDown(com.mojang.blaze3d.platform.InputConstants.KEY_DOWN))  dy += AF_POINT_STEP;
    ...
    private static Float nearestMobInCone(Minecraft mc) {
        ...
        net.minecraft.world.phys.AABB searchBox = new net.minecraft.world.phys.AABB(eye, eye).inflate(50.0);
        ...
        for (LivingEntity e : mc.level.getEntitiesOfClass(LivingEntity.class,
            ...
            *///?}
            ...
            if (toEnt.normalize().dot(look) >= MOB_CONE_COS && dist < best) {
                best = dist;
                bestEntity = e;
            }
        }
    ...
    private static Float trackedMobDistance(Minecraft mc) {
