...
public class SnapmaticaClient implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ...
        shootKey = KeyMappingHelper.registerKeyMapping(new KeyMapping(
                "key.snapmatica.shoot", InputConstants.Type.KEYBOARD, com.mojang.blaze3d.platform.InputConstants.KEY_RETURN, SNAPMATICA_CATEGORY));
        settingsKey = KeyMappingHelper.registerKeyMapping(new KeyMapping(
                "key.snapmatica.settings", InputConstants.Type.KEYBOARD, com.mojang.blaze3d.platform.InputConstants.KEY_G, SNAPMATICA_CATEGORY));
        viewfinderSneakKey = KeyMappingHelper.registerKeyMapping(new KeyMapping(
                "key.snapmatica.viewfinder_sneak", InputConstants.Type.KEYBOARD, com.mojang.blaze3d.platform.InputConstants.KEY_COMMA, SNAPMATICA_CATEGORY));
        orientationKey = KeyMappingHelper.registerKeyMapping(new KeyMapping(
                "key.snapmatica.orientation", InputConstants.Type.KEYBOARD, com.mojang.blaze3d.platform.InputConstants.KEY_V, SNAPMATICA_CATEGORY));
        recordKey = KeyMappingHelper.registerKeyMapping(new KeyMapping(
                "key.snapmatica.record", InputConstants.Type.KEYBOARD, com.mojang.blaze3d.platform.InputConstants.KEY_R, SNAPMATICA_CATEGORY));
        pinKey = KeyMappingHelper.registerKeyMapping(new KeyMapping(
                "key.snapmatica.pin", InputConstants.Type.KEYBOARD, com.mojang.blaze3d.platform.InputConstants.KEY_X, SNAPMATICA_CATEGORY));
        freecamLockKey = KeyMappingHelper.registerKeyMapping(new KeyMapping(
                "key.snapmatica.freecam_lock", InputConstants.Type.KEYBOARD, com.mojang.blaze3d.platform.InputConstants.KEY_C, SNAPMATICA_CATEGORY));
        pathMenuKey = KeyMappingHelper.registerKeyMapping(new KeyMapping(
                "key.snapmatica.path_menu", InputConstants.Type.KEYBOARD, com.mojang.blaze3d.platform.InputConstants.KEY_Z, SNAPMATICA_CATEGORY));
        //?} else {
        /*shootKey = KeyMappingHelper.registerKeyMapping(new KeyMapping(
                "key.snapmatica.shoot", InputConstants.Type.KEYBOARD, com.mojang.blaze3d.platform.InputConstants.KEY_RETURN, "category.snapmatica"));
        settingsKey = KeyMappingHelper.registerKeyMapping(new KeyMapping(
                "key.snapmatica.settings", InputConstants.Type.KEYBOARD, com.mojang.blaze3d.platform.InputConstants.KEY_G, "category.snapmatica"));
        viewfinderSneakKey = KeyMappingHelper.registerKeyMapping(new KeyMapping(
                "key.snapmatica.viewfinder_sneak", InputConstants.Type.KEYBOARD, com.mojang.blaze3d.platform.InputConstants.KEY_COMMA, "category.snapmatica"));
        orientationKey = KeyMappingHelper.registerKeyMapping(new KeyMapping(
                "key.snapmatica.orientation", InputConstants.Type.KEYBOARD, com.mojang.blaze3d.platform.InputConstants.KEY_V, "category.snapmatica"));
        recordKey = KeyMappingHelper.registerKeyMapping(new KeyMapping(
                "key.snapmatica.record", InputConstants.Type.KEYBOARD, com.mojang.blaze3d.platform.InputConstants.KEY_R, "category.snapmatica"));
        pinKey = KeyMappingHelper.registerKeyMapping(new KeyMapping(
                "key.snapmatica.pin", InputConstants.Type.KEYBOARD, com.mojang.blaze3d.platform.InputConstants.KEY_X, "category.snapmatica"));
        freecamLockKey = KeyMappingHelper.registerKeyMapping(new KeyMapping(
                "key.snapmatica.freecam_lock", InputConstants.Type.KEYBOARD, com.mojang.blaze3d.platform.InputConstants.KEY_C, "category.snapmatica"));
        pathMenuKey = KeyMappingHelper.registerKeyMapping(new KeyMapping(
                "key.snapmatica.path_menu", InputConstants.Type.KEYBOARD, com.mojang.blaze3d.platform.InputConstants.KEY_Z, "category.snapmatica"));
        *///?}
        ...
        ClientTickEvents.END_CLIENT_TICK.register(client -> {
            ...
            while (pathMenuKey.consumeClick()) {
                if (client.gui.screen() instanceof CameraPathScreen) {
                    client.gui.setScreen(null);
                } else if (Freecam.isActive() && client.gui.screen() == null) {
                    client.gui.setScreen(new CameraPathScreen());
                }
            }
            Freecam.tick(client);
        ...
        LevelRenderEvents.BEFORE_DEBUG_RENDER.register(ctx -> PhotoCapture.onBeforeTranslucent());
        LevelRenderEvents.LAST.register(ctx -> PhotoCapture.onWorldRenderEnd());
        *///?}
